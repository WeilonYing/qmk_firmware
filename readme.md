...
3. Modified a pre-existing animation runner on the firmware to make the max counter the number of frames in the header file, and mapped each frame matrix coordinate to a corresponding LED on the keyboard.
4. Compiled the firmware into a 226kb binary and then flashed the keyboard with it. 
